...
const uploadConfigs = {
  pdf: fileService.getMulterConfig('pdf'),
  audio: fileService.getMulterConfig('audio'),
  video: fileService.getMulterConfig('video'),
  image: fileService.getMulterConfig('image'),
  document: fileService.getMulterConfig('document'),
  general: fileService.getMulterConfig('default')
};
